      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 z-10">
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm font-medium mb-6">
            ...
            <span>Transforming Energy & Utilities with Technology</span>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Advanced <span className="text-yellow-400">Energy</span> Solutions for Industry Leaders
              </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Utility Companies Served</div>
            </div>
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
            ...
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
              <div className="text-3xl font-bold text-[#8C9AC1] mb-1">60%</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-tesseract-300 mb-6 leading-tight">
                Comprehensive Energy & Utilities Services for Business Excellence
              </h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                Energy & utilities transformation is more than just technology—it's about partnering with you to develop
                actionable solutions that drive measurable business outcomes.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Our comprehensive energy services help you navigate complex regulatory challenges, from digital
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Insights that drive energy decisions</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-tesseract-100 dark:bg-tesseract-900/30 flex items-center justify-center mr-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Energy industry knowledge</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-tesseract-100 dark:bg-tesseract-900/30 flex items-center justify-center mr-4">
                ...
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Optimize asset performance and reduce downtime
                    </p>
                  </div>
                </li>
                <li className="flex items-start group">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Our Energy & Utilities Approach
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              A structured methodology to ensure successful energy transformation with measurable outcomes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-700 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-600 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We work with you to assess your current energy systems, identify challenges, and uncover opportunities
                for improvement.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle
                    ...
                    size={16}
                  />
                  <span className="text-gray-600 dark:text-gray-300 text-sm">Energy process analysis</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle
                    className="text-tesseract-500 dark:text-tesseract-400 mr-2 mt-1 flex-shrink-0"
            ...
            <div className="bg-white dark:bg-gray-700 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-600 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We collaborate with your team to develop a tailored energy strategy that aligns with your business
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              See how our energy & utilities services have helped organizations achieve their business goals
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300 group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Implemented AI-based predictive maintenance solution that reduced equipment failures by 35% and
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <Link
                  href="/case-studies/energy-predictive-maintenance"
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300 group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Deployed smart grid management solution that improved grid reliability by 28% and reduced outage
                duration by 40%.
              </p>
              <div className="flex items-center justify-between text-sm">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <Link
                  href="/case-studies/energy-smart-grid"
                  className="inline-flex items-center text-tesseract-600 hover:text-tesseract-700 dark:text-tesseract-400 dark:hover:text-tesseract-300 font-medium group-hover:translate-x-1 transition-transform duration-300"
                >
                  Read case study <ArrowRight size={16} className="ml-2" />
                </Link>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300 group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Developed customer engagement platform that increased customer satisfaction by 30% and reduced call
                center volume by 25%.
              </p>
              <div className="flex items-center justify-between text-sm">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <Link
                  href="/case-studies/energy-customer-engagement"
                  className="inline-flex items-center text-tesseract-600 hover:text-tesseract-700 dark:text-tesseract-400 dark:hover:text-tesseract-300 font-medium group-hover:translate-x-1 transition-transform duration-300"
                >
                  Read case study <ArrowRight size={16} className="ml-2" />
                </Link>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto mb-10">
            Contact us today to discuss how our energy & utilities solutions can help you achieve your business goals.
          </p>
