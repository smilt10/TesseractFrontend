      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 z-10">
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm font-medium mb-6">
            ...
            <span>Transforming Business with Cloud Technology</span>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Advanced <span className="text-yellow-400">Cloud</span> Solutions for Industry Leaders
              </h1>
              <p className="text-xl text-white/80 mb-8">
                Accelerate digital transformation with cloud solutions that enhance scalability, improve performance,
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-all duration-300">
              <Image
                src="/cloud-transformation-hero.png"
                alt="Cloud Transformation Solutions"
                fill
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Cloud Migrations Completed</div>
            </div>
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
              <div
                className="text-3xl font-bold text-tesseract-500 dark:text-tesseract-300 mb-1"
                style={{ color: "#8C9AC1" }}
              >
                40%
              </div>
            ...
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
              <div className="text-3xl font-bold text-tesseract-500 dark:text-tesseract-300 mb-1">99.9%</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Uptime Achievement</div>
            </div>
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-tesseract-300 mb-6 leading-tight">
                Comprehensive Cloud Services for Business Excellence
              </h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                Cloud transformation is more than just technology—it's about partnering with you to develop actionable
                solutions that drive measurable business outcomes.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Our comprehensive cloud services help you navigate complex infrastructure challenges, from digital
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Insights that drive cloud decisions</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-tesseract-100 dark:bg-tesseract-900/30 flex items-center justify-center mr-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Cloud platform knowledge</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-tesseract-100 dark:bg-tesseract-900/30 flex items-center justify-center mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Cloud experience expertise</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Enterprise-grade security solutions</p>
                  </div>
                </li>
                <li className="flex items-start group">
                  <CheckCircle
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Maximize ROI with smart cloud spending
                    </p>
                  </div>
                </li>
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Optimize workloads across cloud providers
                    </p>
                  </div>
                </li>
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Build applications for cloud environments
                    </p>
                  </div>
                </li>
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Unlock insights from your cloud infrastructure
                    </p>
                  </div>
                </li>
                <li className="flex items-start group">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              A structured methodology to ensure successful cloud transformation with measurable outcomes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-700 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-600 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We work with you to assess your current cloud infrastructure, identify challenges, and uncover
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle
                    ...
                    size={16}
                  />
                  <span className="text-gray-600 dark:text-gray-300 text-sm">Infrastructure analysis</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle
                    className="text-tesseract-500 dark:text-tesseract-400 mr-2 mt-1 flex-shrink-0"
                    size={16}
                  />
                  <span className="text-gray-600 dark:text-gray-300 text-sm">Cloud readiness assessment</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle
                    className="text-tesseract-500 dark:text-tesseract-400 mr-2 mt-1 flex-shrink-0"
            ...
            <div className="bg-white dark:bg-gray-700 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-600 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We collaborate with your team to develop a tailored cloud strategy that aligns with your business
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              See how our cloud services have helped organizations achieve their business goals
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300 group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Migrated core banking systems to the cloud, resulting in a 40% reduction in operational costs and a 60%
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <Link
                  href="/case-studies/cloud-banking-transformation"
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300 group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Implemented a cloud-native architecture that improved scalability by 10x and enhanced customer
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <Link
                  href="/case-studies/ecommerce-cloud-scaling"
                  className="inline-flex items-center text-tesseract-600 hover:text-tesseract-700 dark:text-tesseract-400 dark:hover:text-tesseract-300 font-medium group-hover:translate-x-1 transition-transform duration-300"
                >
                  Read case study <ArrowRight size={16} className="ml-2" />
                </Link>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300 group">
              <div className="bg-tesseract-100 dark:bg-tesseract-900/30 text-tesseract-600 dark:text-tesseract-400 w-12 h-12 rounded-full flex items-center justify-center mb-6 group-hover:bg-tesseract-500 group-hover:text-white dark:group-hover:bg-tesseract-500 transition-all duration-300">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"
                  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 group-hover:text-tesseract-500 dark:group-hover:text-tesseract-300 transition-colors duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Implemented a secure cloud infrastructure for patient data, resulting in 70% faster data processing and
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <Link
                  href="/case-studies/healthcare-cloud-security"
                  className="inline-flex items-center text-tesseract-600 hover:text-tesseract-700 dark:text-tesseract-400 dark:hover:text-tesseract-300 font-medium group-hover:translate-x-1 transition-transform duration-300"
                >
                  Read case study <ArrowRight size={16} className="ml-2" />
                </Link>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto mb-10">
            Contact us today to discuss how our cloud transformation solutions can help you achieve your business goals.
          </p>
