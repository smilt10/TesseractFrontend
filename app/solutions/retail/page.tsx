    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 z-10">
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm font-medium mb-6">
            ...
            <span>Transforming Retail with Technology</span>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Advanced <span className="text-yellow-400">Retail</span> Solutions for Industry Leaders
              </h1>
              <p className="text-xl text-white/80 mb-8">
                Accelerate digital transformation in retail with AI-powered solutions that enhance customer experiences,
                improve inventory management, and drive operational efficiency
              </p>
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-all duration-300">
              <Image src="/retail-solution.png" alt="Retail Solutions" fill className="object-cover" priority />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Retail Businesses Served</div>
            </div>
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
              <div className="text-3xl font-bold text-tesseract-500 dark:text-tesseract-300 mb-1">35%</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Average Sales Increase</div>
            </div>
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
              <div className="text-3xl font-bold text-tesseract-500 dark:text-tesseract-300 mb-1">60%</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Customer Satisfaction Improvement</div>
            </div>
            <div className="text-center p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-tesseract-300 mb-6 leading-tight">
                Comprehensive Retail Solutions for Business Excellence
              </h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                Retail transformation is more than just technology—it's about partnering with you to develop actionable
                solutions that drive measurable business outcomes.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Our comprehensive retail solutions help you navigate complex market challenges, from digital
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Insights that drive retail decisions</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-tesseract-100 dark:bg-tesseract-900/30 flex items-center justify-center mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Adaptable to market changes</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-tesseract-100 dark:bg-tesseract-900/30 flex items-center justify-center mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Retail industry knowledge</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-tesseract-100 dark:bg-tesseract-900/30 flex items-center justify-center mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Omnichannel experience expertise</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Deliver targeted experiences based on customer data
                    </p>
                  </div>
                </li>
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Monitor and optimize in-store operations and customer behavior
                    </p>
                  </div>
                </li>
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Improve visibility, resilience, and efficiency in your supply chain
                    </p>
                  </div>
                </li>
                <li className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Unlock insights from your retail data assets
                    </p>
                  </div>
                </li>
                <li className="flex items-start group">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Our Retail Services Approach
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              A structured methodology to ensure successful retail transformation with measurable outcomes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-700 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-600 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We work with you to assess your current retail systems, identify challenges, and uncover opportunities
                for improvement.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle
                    ...
                    size={16}
                  />
                  <span className="text-gray-600 dark:text-gray-300 text-sm">Customer journey analysis</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle
                    className="text-tesseract-500 dark:text-tesseract-400 mr-2 mt-1 flex-shrink-0"
            ...
            <div className="bg-white dark:bg-gray-700 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-600 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We collaborate with your team to develop a tailored retail strategy that aligns with your business
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              See how our retail services have helped organizations achieve their business goals
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300 group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Implemented a unified commerce platform that increased online sales by 45% and improved customer
                satisfaction scores by 35% for a global retail chain.
              </p>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <Link
                  href="/case-studies/retail-omnichannel-transformation"
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300 group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Deployed AI-based inventory management solution that reduced stockouts by 30% and inventory costs by 20%
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <Link
                  href="/case-studies/retail-inventory-optimization"
                  className="inline-flex items-center text-tesseract-600 hover:text-tesseract-700 dark:text-tesseract-400 dark:hover:text-tesseract-300 font-medium group-hover:translate-x-1 transition-transform duration-300"
                >
                  Read case study <ArrowRight size={16} className="ml-2" />
                </Link>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:translate-y-[-5px] transition-all duration-300 group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Implemented personalized marketing platform that increased conversion rates by 35% and customer lifetime
                value by 25% for a specialty retailer.
              </p>
              <div className="flex items-center justify-between text-sm">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <Link
                  href="/case-studies/retail-personalized-marketing"
                  className="inline-flex items-center text-tesseract-600 hover:text-tesseract-700 dark:text-tesseract-400 dark:hover:text-tesseract-300 font-medium group-hover:translate-x-1 transition-transform duration-300"
                >
                  Read case study <ArrowRight size={16} className="ml-2" />
                </Link>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Transform Your Retail Operations?</h2>
          <p className="text-xl text-white/80 max-w-2xl mx-auto mb-10">
            Contact us today to discuss how our retail solutions can help you improve efficiency, enhance customer
